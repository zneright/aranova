...
// --- STRICT V2 IMPORTS: Manually importing the specific wallet modules ---
import {
  StellarWalletsKit,
  FreighterModule,
  xBullModule
...
const AuthPage: React.FC = () => {
  ...
  // --- NEW: Refactored Wallet Connection specifically for v2 APIs ---
  const handleConnectExtension = async () => {
    setWalletMode("connect");
    setErrors({ ...errors, wallet: "" });

    try {
      // 1. Manually initialize the modules we want to offer
      const kit = new StellarWalletsKit({
        network: "PUBLIC" as any,
      ...
      // 2. Open the modal letting the user pick between Freighter and xBull (Lobstr etc)
      await kit.openModal({
