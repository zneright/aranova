...
// ─── REAL BLOCKCHAIN IMPORTS (FIXED SERVER ERROR) ───
import {
  Networks,
  TransactionBuilder,
  Contract,
...
const submitRealSorobanTransaction = async (publicKey: string, method: string, args: xdr.ScVal[]) => {
  ...
  // Direct reference to SorobanRpc avoids the "undefined Server" error
  ...
  tx = SorobanRpc.assembleTransaction(tx, simulated) as Transaction;
