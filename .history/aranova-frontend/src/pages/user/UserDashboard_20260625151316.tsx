...
const DashboardContent: React.FC = () => {
  ...
  const TxIcon = ({ icon }: { icon: TxItem["icon"] }) =>
    icon === "bus" ? <IconBus /> : icon === "trend" ? <IconTrendUp /> : <IconLockSm />;
    ...
    <div style={{ maxWidth: 960, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <div
          style={{
            ...
            background: dark ? "#1A2644" : "#EEF4FF",
            border: `1px solid ${dark ? "rgba(79,142,247,.3)" : "rgba(22,82,201,.2)"}`,
        ...
        >
          <span
            style={{
              ...
              borderRadius: "50%", background: t.blueText,
              display: "inline-block", animation: "mobilispulse 2s infinite",
            }}
          />
          <span style={{ fontSize: 11, fontWeight: 700, color: t.blueText, letterSpacing: ".4px", textTransform: "uppercase" }}>
      ...
      >
        ...
        <div style={{ gridColumn: "1 / 3", display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div
            style={{
              background: "linear-gradient(135deg, #1652C9 0%, #0A1931 100%)",
          ...
          >
            ...
            />
            <p style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,.65)", marginBottom: 6 }}>
              Available to Spend
            </p>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 28 }}>
              <button
                style={{
                  flex: 1, background: "#fff", color: "#1652C9",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            ...
            <div
              style={{
                background: dark ? "#1F1A0A" : "#FFFBEB",
                border: `1px solid ${dark ? "#78350F" : "#F4D03F"}`,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    borderRadius: 12, letterSpacing: ".4px",
                  }}
                >
                  EXCELLENT
                </div>
            ...
            <div
              style={{
                background: t.bgPage, borderRadius: 10,
                padding: "10px 12px", fontSize: 12,
                color: t.textMuted, lineHeight: 1.5,
              }}
            >
              You qualify for an automated{" "}
              <strong style={{ color: t.textPrim }}>50 USDC</strong>{" "}
              fuel loan based on your collateral.
            </div>
          </div>
            ...
            {TRANSACTIONS.map((tx, i) => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div style={txIconStyle(tx.color)}>
                    <TxIcon icon={tx.icon} />
                  </div>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 13, color: t.textPrim }}>{tx.name}</div>
                    <div style={{ fontSize: 10, fontWeight: 600, color: t.textFaint, textTransform: "uppercase", letterSpacing: ".4px", marginTop: 1 }}>
                      {tx.meta}
                    </div>
                  </div>
                </div>
