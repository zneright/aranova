...
// Add SorobanRpc to your existing stellar-sdk imports
import {
  Networks,
  TransactionBuilder,
  Operation,
...
const NATIVE_XLM_CONTRACT_ID = "CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC"; // Native XLM Token Contract
...
const DriverContent: React.FC<{ userData: any }> = ({ userData }) => {
  ...
  // FIXED: Using Soroban Contract Call for Repayment
  const handleRepayFuelCredit = async () => {
    ...
    try {
      ...
      // Initialize the Soroban Contract instance
