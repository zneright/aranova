        ...
        <div className="space-y-6">
            ...
            <div className="lg:hidden space-y-6">
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className={`group relative overflow-hidden rounded-[24px] p-6 border shadow-lg flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[#FFE600]/40 ${dark ? 'bg-gradient-to-br from-[#0E0F14] to-[#161822] border-white/5' : 'bg-gradient-to-br from-[#1E293B] to-[#0F172A]'
                        }`}>
                    ...
                    <div className="grid grid-rows-2 gap-3">
                        ...
                        <button
                            ...
                            className={`flex items-center justify-center p-4 rounded-[20px] border hover:-translate-y-0.5 hover:shadow-lg active:scale-95 transition-all gap-2 font-black text-xs uppercase tracking-wider shadow-md ${dark ? 'border-white/10 bg-white/5 text-white hover:border-white/30' : 'border-gray-200 bg-gray-50 text-gray-800 hover:bg-gray-100 hover:border-gray-300'
                                }`}
                        >
                            📥 Receive
                        </button>
                ...
                <div className={`rounded-[24px] p-6 border shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[#FFE600]/30 ${dark ? 'bg-[#0E0F14] border-white/5' : 'bg-white border-[#E2E2DF]'}`}>
                    ...
                    <button
                        ...
                        className={`w-full py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider border active:scale-95 transition-all ${dark ? 'border-white/10 text-white hover:bg-white/10 hover:border-[#FFE600]/50' : 'border-gray-200 text-gray-800 hover:bg-gray-50 hover:border-[#FFE600]/50'
                            }`}
                    >
                        Withdraw
                    </button>
            ...
            <div className="hidden lg:block space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6 items-stretch">
                    ...
                    <div className="h-full flex flex-col">
                        <div className={`group relative overflow-hidden rounded-[32px] p-8 flex flex-col justify-between flex-1 border shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-[#FFE600]/40 ${dark ? 'bg-gradient-to-br from-[#0E0F14] to-[#161822] border-white/5' : 'bg-gradient-to-br from-[#1E293B] to-[#0F172A]'
                            }`}>
    ...
    const renderDriver = () => (
        <div className="space-y-6">
            ...
            <div className="lg:hidden space-y-6">
                <div className="grid grid-cols-2 gap-4">
                    {/* Left Column: Wallet Balance Card */}
                    <div className={`group relative overflow-hidden rounded-[24px] p-6 border shadow-lg flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[#FF6B00]/40 ${dark ? 'bg-gradient-to-br from-[#141620] to-[#251A14] border-white/5' : 'bg-gradient-to-br from-[#2D231E] to-[#1C1512]'
                        }`}>
                    ...
                    <div className="grid grid-rows-2 gap-3">
                        ...
                        <button
                            onClick={() => setShowReceiveModal(true)}
                            className={`flex items-center justify-center p-4 rounded-[20px] border active:scale-95 hover:-translate-y-0.5 hover:shadow-lg transition-all gap-2 font-black text-xs uppercase tracking-wider shadow-md ${dark ? 'border-white/10 bg-white/5 text-white hover:border-white/30' : 'border-gray-200 bg-gray-50 text-gray-800 hover:bg-gray-100 hover:border-gray-300'
                                }`}
                        >
                            📥 Receive
                        </button>
                ...
                <div className={`rounded-[24px] p-6 border shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[#FF6B00]/30 ${dark ? 'bg-[#141620] border-white/5' : 'bg-white border-[#EAE6DF]'}`}>
                    ...
                    <button
                        onClick={() => alert("Withdraw is reserved for future PDAX integration.")}
                        className={`w-full py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider border active:scale-95 transition-all ${dark ? 'border-white/10 text-white hover:bg-white/10 hover:border-[#FF6B00]/50' : 'border-gray-200 text-gray-800 hover:bg-gray-50 hover:border-[#FF6B00]/50'
                            }`}
                    >
                        Withdraw
                    </button>
            ...
            <div className="hidden lg:block space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6 items-stretch">
                    {/* Left Column: Wallet Balance Card */}
                    <div className="h-full flex flex-col">
                        <div className={`group relative overflow-hidden rounded-[32px] p-8 flex flex-col justify-between border shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-[#FF6B00]/40 ${dark ? 'bg-gradient-to-br from-[#141620] to-[#251A14] border-white/5' : 'bg-gradient-to-br from-[#2D231E] to-[#1C1512]'
                            }`}>
    ...
    const renderCooperative = () => (
        <div className="space-y-6">
            ...
            <div className="lg:hidden space-y-6">
                <div className="grid grid-cols-2 gap-4">
                    {/* Left Column: Wallet Balance Card */}
                    <div className={`group relative overflow-hidden rounded-[24px] p-6 border shadow-lg flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[#10B981]/40 ${dark ? 'bg-gradient-to-br from-[#0A1128] to-[#0D1635] border-white/5' : 'bg-gradient-to-br from-[#064E3B] to-[#022C22]'
                        }`}>
                ...
                <div className={`rounded-[24px] p-6 border shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[#10B981]/30 ${dark ? 'bg-[#0A1128] border-white/5' : 'bg-white border-[#D5E2EC]'}`}>
                    ...
                    <button
                        onClick={() => alert("Withdraw is reserved for future PDAX integration.")}
                        className={`w-full py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider border active:scale-95 transition-all ${dark ? 'border-white/10 text-white hover:bg-white/10 hover:border-[#10B981]/50' : 'border-gray-200 text-gray-800 hover:bg-gray-50 hover:border-[#10B981]/50'
                            }`}
                    >
                        Withdraw
                    </button>
            ...
            <div className="hidden lg:block space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6 items-stretch">
                    ...
                    <div className="h-full flex flex-col">
                        <div className={`group relative overflow-hidden rounded-[32px] p-8 flex flex-col justify-between border shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-[#10B981]/40 ${dark ? 'bg-gradient-to-br from-[#0A1128] to-[#0D1635] border-white/5' : 'bg-gradient-to-br from-[#064E3B] to-[#022C22]'
                            }`}>
            ...
            {offlineQueueLength > 0 && (
                <div className={`border rounded-[28px] p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-all duration-300 ${dark ? 'bg-blue-950/20 border-blue-900/30' : 'bg-blue-50 border-blue-100'}`}>
                    ...
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider disabled:opacity-50 transition-all ${role === 'driver'
                ...
                <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
                    <div className={`rounded-[32px] p-8 max-w-sm w-full border shadow-2xl transition-all ${dark ? 'bg-[#0E0F14] border-white/10 text-white' : 'bg-white border-gray-100 text-gray-900'}`}>
                        ...
                        <div className="space-y-4 mb-6">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className={`w-full ${dark ? 'bg-white/5 border-white/10 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400'} px-4 py-3 rounded-xl border text-sm font-semibold focus:outline-none focus:ring-2 ${role === 'driver' ? 'focus:ring-[#FF6B00]' : role === 'cooperative' ? 'focus:ring-[#10B981]' : 'focus:ring-[#FFE600]'
                                        } transition-all`}
                                />
                                <button
                                    onClick={() => setScanning((s) => !s)}
                        ...
                        <div className="flex gap-3">
                            <button
                                className={`flex-1 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider text-white transition-all ${role === 'driver'
            ...
            {showReceiveModal && (
                <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
                    <div className={`rounded-[32px] p-8 max-w-sm w-full text-center border shadow-2xl transition-all ${dark ? 'bg-[#0E0F14] border-white/10 text-white' : 'bg-white border-gray-100 text-gray-900'}`}>
                        ...
                        <div className="flex gap-2">
                            <button
                                className={`flex-1 py-3 rounded-xl font-bold text-xs uppercase tracking-wider transition-all ${role === 'driver'
                                    ? 'bg-[#FF6B00] text-white hover:bg-[#E05E00]'
                                    : role === 'cooperative'
                                        ? 'bg-[#10B981] text-white hover:bg-[#0E9F6E]'
                                        : 'bg-black text-[#FFE600] dark:bg-[#FFE600] dark:text-black hover:opacity-90'
