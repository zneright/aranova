...
const UserVault = () => {
  ...
  // Determine dark mode condition dynamically before rendering full application layout
  const isDarkMode = userData?.dark || false;

  if (authLoading) {
    return <LoadingWorkspace message="Syncing vault cryptographic allocations with Horizon ledger..." dark={isDarkMode} />;
  }
