...
const CommuterPanel: React.FC<{ userData: any; onRefresh: () => void }> = ({ userData, onRefresh }) => {
    ...
    const renderCommuter = () => (
      <div className="space-y-6">
        ...
        <div className="lg:hidden space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className={`relative overflow-hidden rounded-[24px] p-6 border shadow-lg flex flex-col justify-between transition-all duration-300 ${
              ...
              <div className="text-[9px] text-gray-400 mt-2 font-bold uppercase">XLM Balance</div>
            </div>
            ...
            <div className="grid grid-rows-2 gap-3">
              <button 
                ...
                className="flex items-center justify-center p-4 rounded-[20px] border border-[#FFE600]/20 bg-[#FFE600] text-black font-black text-xs uppercase tracking-wider shadow-md active:scale-95 transition-all gap-2"
              >
                💸 Pay
              </button>
              <button 
        ...
        {/* LAPTOP / DESKTOP VIEW (Visible ONLY on large screens) */}
        <div className="hidden lg:grid lg:grid-cols-2 gap-6 items-stretch">
          {/* Left Column: Entirely Wallet Balance Card */}
          <div className="h-full flex flex-col">
            <div className={`relative overflow-hidden rounded-[32px] p-8 flex flex-col justify-between flex-1 border shadow-xl transition-all duration-300 ${
              dark ? 'bg-gradient-to-br from-[#0E0F14] to-[#161822] border-white/5' : 'bg-gradient-to-br from-[#1E293B] to-[#0F172A]'
            }`}>
          ...
          {/* Right Column: Single card housing Pay, Receive AND Withdraw */}
          <div className="h-full flex flex-col">
            <div className={`rounded-[32px] p-8 border shadow-xl flex-1 flex flex-col justify-between transition-all duration-300 ${dark ? 'bg-[#0E0F14] border-white/5' : 'bg-white border-[#E2E2DF]'}`}>
              {/* Pay & Receive Portion */}
              <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex-1">
                      <input 
                        ...
                        className={`w-full ${dark ? 'bg-white/5 border-white/10 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400'} px-4 py-3 rounded-xl border text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#FFE600] transition-all`}
                      />
                    </div>
                    <button 
                      onClick={() => setScanning((s) => !s)} 
                      className={`px-5 py-3 rounded-xl font-bold text-xs uppercase tracking-wider border flex items-center justify-center gap-2 whitespace-nowrap active:scale-95 transition-all ${scanning ? 'bg-red-500/10 border-red-500/30 text-red-500' : (dark ? 'bg-white/5 border-white/10 text-white hover:bg-white/10' : 'bg-gray-100 border-gray-200 text-gray-800 hover:bg-gray-200')}`}
                    >
                ...
                <div className="flex flex-wrap gap-2 mt-6">
                  <button 
                    onClick={handleSend} 
                    disabled={busy} 
                    className="px-6 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider bg-[#FFE600] text-black hover:bg-[#E6CE00] disabled:opacity-50 active:scale-95 transition-all"
                  >
                    Pay
                  </button>
                  <button 
                    onClick={() => setShowReceiveModal(true)} 
                    className={`px-5 py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider border active:scale-95 transition-all ${dark ? 'border-white/10 text-white hover:bg-white/5' : 'border-gray-200 text-gray-800 hover:bg-gray-50'}`}
                  >
                    Receive
                  </button>
                </div>
              ...
              <div>
                ...
                <button 
                  onClick={() => alert("Withdraw is reserved for future PDAX integration.")} 
                  className={`w-full py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider border active:scale-95 transition-all ${dark ? 'border-white/10 text-white hover:bg-white/5' : 'border-gray-200 text-gray-800 hover:bg-gray-50'}`}
                >
                  Withdraw
                </button>
              </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className={`rounded-[24px] p-6 border shadow-sm transition-all duration-300 ${dark ? 'bg-[#0E0F14] border-white/5' : 'bg-white border-[#E2E2DF]'}`}>
        ...
        <div className={`rounded-[28px] p-6 border shadow-sm transition-all duration-300 ${dark ? 'bg-[#0E0F14] border-white/5' : 'bg-white border-[#E2E2DF]'}`}>
    ...
    const renderDriver = () => (
      <div className="space-y-6">
        ...
        <div className="lg:hidden space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className={`relative overflow-hidden rounded-[24px] p-6 border shadow-lg flex flex-col justify-between transition-all duration-300 ${
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FF6B00] opacity-[0.03] rounded-full blur-2xl -mr-8 -mt-8 pointer-events-none"></div>
              <div>
                <span className="text-[10px] font-black uppercase tracking-wider text-gray-400">Wallet</span>
                <h1 className="text-xl sm:text-2xl font-black text-white mt-2">
                  {formatXlm(Number(userData.walletBalance || 0))}
            ...
            <div className="grid grid-rows-2 gap-3">
              <button 
                onClick={() => setShowPayModal(true)} 
                className="flex items-center justify-center p-4 rounded-[20px] border border-[#FF6B00]/20 bg-[#FF6B00] text-white font-black text-xs uppercase tracking-wider shadow-md active:scale-95 transition-all gap-2"
              >
                💸 Pay
              </button>
              <button 
          ...
          {/* Below it: Withdraw Card */}
          <div className={`rounded-[24px] p-6 border shadow-md transition-all duration-300 ${dark ? 'bg-[#141620] border-white/5' : 'bg-white border-[#EAE6DF]'}`}>
            <h3 className="text-sm font-black mb-1">Withdraw</h3>
            <p className="text-[10px] text-gray-400 mb-4">Withdraw to external Stellar exchange terminals.</p>
            <button 
              onClick={() => alert("Withdraw is reserved for future PDAX integration.")} 
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-6 items-stretch">
          {/* Left Column: Entirely Wallet Balance Card */}
          <div className="h-full flex flex-col">
            <div className={`relative overflow-hidden rounded-[32px] p-8 flex flex-col justify-between border shadow-xl transition-all duration-300 ${
              dark ? 'bg-gradient-to-br from-[#141620] to-[#251A14] border-white/5' : 'bg-gradient-to-br from-[#2D231E] to-[#1C1512]'
            }`}>
          ...
          {/* Right Column: Single card housing Pay, Receive AND Withdraw */}
          <div className="h-full flex flex-col">
            <div className={`rounded-[32px] p-8 border shadow-xl flex-1 flex flex-col justify-between transition-all duration-300 ${dark ? 'bg-[#141620] border-white/5' : 'bg-white border-[#EAE6DF]'}`}>
              {/* Pay & Receive Portion */}
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                  ...
                  <button 
                    onClick={() => setScanning((s) => !s)} 
                    className={`px-5 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider text-white bg-[#FF6B00] hover:bg-[#E05E00] active:scale-95 transition-all flex items-center justify-center gap-2 shadow-md shadow-[#FF6B00]/15`}
                  >
                ...
                <div className="space-y-4">
                  <input 
                    ...
                    onChange={(e) => setRecipient(e.target.value)} 
                    placeholder="Recipient address, public key or email" 
                    className={`w-full ${dark ? 'bg-white/5 border-white/10 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400'} px-4 py-3 rounded-xl border text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all`}
                  />
                ...
                <div className="flex flex-wrap gap-2 mt-6">
                  <button 
                    onClick={handleSend} 
                    disabled={busy} 
                    className="px-6 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider bg-[#FF6B00] text-white hover:bg-[#E05E00] disabled:opacity-50 active:scale-95 transition-all"
                  >
                    Pay
                  </button>
                  <button 
        ...
        {/* Stats Row (Always visible below the main grid) */}
        <div className="grid grid-cols-2 gap-4">
          <div className={`rounded-[24px] p-6 border shadow-sm transition-all duration-300 ${dark ? 'bg-[#141620] border-white/5' : 'bg-white border-[#EAE6DF]'}`}>
            <div className="flex flex-col justify-between h-full">
              <div>
                <span className={`text-[10px] font-black uppercase tracking-wider ${dark ? 'text-gray-400' : 'text-gray-500'}`}>Locked Savings</span>
                <h2 className="text-xl sm:text-2xl font-black mt-2">
                  {formatXlm(Number(userData.vaultBalance || 0))}
                </h2>
              </div>
          ...
          <div className={`rounded-[24px] p-6 border shadow-sm transition-all duration-300 ${dark ? 'bg-[#141620] border-white/5' : 'bg-white border-[#EAE6DF]'}`}>
            <div className="flex flex-col justify-between h-full">
              <div>
                <span className={`text-[10px] font-black uppercase tracking-wider ${dark ? 'text-gray-400' : 'text-gray-500'}`}>Trust Standing</span>
                <h2 className="text-xl sm:text-2xl font-black mt-2">
                  {Number(userData.trustScore || 0)}/100
                </h2>
              </div>
        ...
        <div className={`rounded-[28px] p-6 border shadow-sm transition-all duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${dark ? 'bg-[#141620] border-white/5' : 'bg-white border-[#EAE6DF]'}`}>
          <div>
          ...
          <a href="/user/loans" className={`px-4 py-2 rounded-xl text-xs font-black uppercase text-white bg-[#FF6B00] hover:bg-[#E05E00] active:scale-95 transition-all shadow-md shadow-[#FF6B00]/10`}>
            Driver Loan Panel
          </a>
        </div>
      </div>
    ...
    const renderCooperative = () => (
      <div className="space-y-6">
        ...
        <div className="lg:hidden space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className={`relative overflow-hidden rounded-[24px] p-6 border shadow-lg flex flex-col justify-between transition-all duration-300 ${
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#10B981] opacity-[0.03] rounded-full blur-2xl -mr-8 -mt-8 pointer-events-none"></div>
              <div>
                <span className="text-[10px] font-black uppercase tracking-wider text-gray-400">Wallet</span>
                <h1 className="text-xl sm:text-2xl font-black text-white mt-2">
                  {formatXlm(Number(userData.walletBalance || 0))}
            ...
            <div className="grid grid-rows-2 gap-3">
              <button 
                onClick={() => setShowPayModal(true)} 
                className="flex items-center justify-center p-4 rounded-[20px] border border-[#10B981]/20 bg-[#10B981] text-white font-black text-xs uppercase tracking-wider shadow-md active:scale-95 transition-all gap-2"
              >
                💸 Pay
              </button>
              <button 
          ...
          {/* Below it: Withdraw Card */}
          <div className={`rounded-[24px] p-6 border shadow-md transition-all duration-300 ${dark ? 'bg-[#0A1128] border-white/5' : 'bg-white border-[#D5E2EC]'}`}>
            <h3 className="text-sm font-black mb-1">Withdraw</h3>
            <p className="text-[10px] text-gray-400 mb-4">Withdraw to external Stellar exchange terminals.</p>
            <button 
              onClick={() => alert("Withdraw is reserved for future PDAX integration.")} 
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-6 items-stretch">
          ...
          {/* Right Column: Single card housing Pay, Receive AND Withdraw */}
          <div className="h-full flex flex-col">
            <div className={`rounded-[32px] p-8 border shadow-xl flex-1 flex flex-col justify-between transition-all duration-300 ${dark ? 'bg-[#0A1128] border-white/5' : 'bg-white border-[#D5E2EC]'}`}>
              {/* Pay & Receive Portion */}
              <div>
                <h3 className="text-lg font-black mb-2">Pay & Receive</h3>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex-1">
                      <input 
                        ...
                        onChange={(e) => setRecipient(e.target.value)} 
                        placeholder="Recipient address, public key or email" 
                        className={`w-full ${dark ? 'bg-white/5 border-white/10 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400'} px-4 py-3 rounded-xl border text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#10B981] transition-all`}
                      />
                    </div>
                    <button 
                      onClick={() => setScanning((s) => !s)} 
                      className={`px-4 py-3 rounded-xl font-bold text-xs uppercase tracking-wider border flex items-center justify-center gap-2 whitespace-nowrap active:scale-95 transition-all ${scanning ? 'bg-red-500/10 border-red-500/30 text-red-500' : (dark ? 'bg-white/5 border-white/10 text-white hover:bg-white/10' : 'bg-gray-100 border-gray-200 text-gray-800 hover:bg-gray-200')}`}
                    >
                      {scanning ? "Close Cam" : "📷 Scan QR"}
                    </button>
                  </div>
                ...
                <div className="flex flex-wrap gap-2 pt-6 border-t border-dashed border-gray-200 dark:border-white/5 mt-6">
                  <button 
                    onClick={handleSend} 
                    disabled={busy} 
                    className="px-6 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider bg-[#10B981] text-white hover:bg-[#0E9F6E] disabled:opacity-50 active:scale-95 transition-all"
                  >
                    Pay
                  </button>
                  <button 
        ...
        {/* Stats Row (Always visible below the main grid) */}
        <div className="grid grid-cols-2 gap-4">
          <div className={`rounded-[24px] p-6 border shadow-sm transition-all duration-300 ${dark ? 'bg-[#0A1128] border-white/5' : 'bg-white border-[#D5E2EC]'}`}>
            <div className="flex flex-col justify-between h-full">
              <div>
                <span className={`text-[10px] font-black uppercase tracking-wider ${dark ? 'text-gray-400' : 'text-gray-500'}`}>Reserve Lockups</span>
                <h2 className="text-xl sm:text-2xl font-black mt-2">
                  {formatXlm(Number(userData.vaultBalance || 0))}
                </h2>
              </div>
          ...
          <div className={`rounded-[24px] p-6 border shadow-sm transition-all duration-300 ${dark ? 'bg-[#0A1128] border-white/5' : 'bg-white border-[#D5E2EC]'}`}>
            <div className="flex flex-col justify-between h-full">
              <div>
                <span className={`text-[10px] font-black uppercase tracking-wider ${dark ? 'text-gray-400' : 'text-gray-500'}`}>Cooperative Trust</span>
                <h2 className="text-xl sm:text-2xl font-black mt-2">
                  {Number(userData.trustScore || 0)}/100
                </h2>
              </div>
        ...
        <div className={`rounded-[28px] p-6 border shadow-sm transition-all duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${dark ? 'bg-[#0A1128] border-white/5' : 'bg-white border-[#D5E2EC]'}`}>
          <div>
          ...
          <a href="/user/coop-pool" className={`px-4 py-2 rounded-xl text-xs font-black uppercase text-white bg-[#10B981] hover:bg-[#0E9F6E] active:scale-95 transition-all shadow-md shadow-[#10B981]/10`}>
            Manage Fuel Pool
          </a>
        </div>
      </div>
