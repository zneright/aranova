...
const signAndSubmitStellarTransaction = async (txBuilder: TransactionBuilder, userData: any, horizon: Horizon.Server) => {
  ...
  // Detect if wallet was generated internally (has encrypted secret key in Firestore)
  if (userData?.encryptedSecretKey) {

    // 1. AUTO-SIGN: Ask for PIN to decrypt the local wallet
    ...
    try {
      ...
      // Sign using the native SDK Keypair
    ...
    // 2. EXTENSION-SIGN: Route to Freighter/xBull for externally connected wallets
